...
func NewAbstractMap[K, V any](abstractMap AbstractMap[K, V]) *DefaultAbstractMap[K, V] {
...
func (m *DefaultAbstractMap[K, V]) Len() (len int) {
	for range m.m.Range {
		len += 1
	}
	return len
